...
fun paletteFor(t: TimeOfDay): RootPalette = when (t) {
    TimeOfDay.MIDNIGHT -> RootPalette(
        ...
        surface = Color(0x9910151F), onSurface = Color(0xFFE7EAF1), dim = Color(0xFF79808E),
    ...
    TimeOfDay.NIGHT -> RootPalette(
        ...
        surface = Color(0x99183056), onSurface = Color(0xFFEAF1FB), dim = Color(0xFF93A6C6),
    ...
    TimeOfDay.DUSK -> RootPalette(
        ...
        surface = Color(0xB8FFFFFF), onSurface = Color(0xFF2E2333), dim = Color(0xFF7A6A5E),
    ...
    TimeOfDay.DAWN -> RootPalette(
        ...
        surface = Color(0xB8FFFFFF), onSurface = Color(0xFF22283A), dim = Color(0xFF69708A),
    ...
    TimeOfDay.DAY -> RootPalette(
        ...
        surface = Color(0xB8FFFFFF), onSurface = Color(0xFF12202E), dim = Color(0xFF5A6675),
...
fun RootTheme(
    ...
    val scheme = base.copy(
        ...
        // Glassy modals/menus: dialogs pull from the surfaceContainer tokens, so point them
        // at our translucent surface too.
